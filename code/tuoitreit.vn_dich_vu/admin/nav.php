<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="https://www.facebook.com/thangvip9x" class="nav-link">LIÊN HỆ KỸ THUẬT</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Hãy gọi cho tôi</p>
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Giúp tôi với</p>
                <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 4 giờ trước</p>
              </div>
            </div>
            <!-- Message End -->
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-users mr-2"></i> 9 yêu cầu kết bạn
            <span class="float-right text-muted text-sm">12 giờ trước</span>
          </a>
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
